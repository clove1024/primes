<template>
    <div style="max-height:80vh;">
        ...
        <wj-flex-grid
            ...
            class="wj-felx-grid"
        >
            <wj-flex-grid-filter :filterColumns="['RowHeader','prodNumber','prodName','standard','productType',]" />
            <wj-flex-grid-cell-template cellType="RowHeader" v-slot="cell">{{cell.row.index + 1}}</wj-flex-grid-cell-template>
            <wj-flex-grid-column binding="prodNumber" header="ProdNumber" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="prodName" header="ProdName" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="standard" header="Standard" width="2*" :isReadOnly="true" align="center" />
