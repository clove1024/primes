<template>
    <v-card outlined>
        ...
        <v-card-text>
            <div>
                <String label="ProdNumber" v-model="item.prodNumber" :editMode="editMode" @change="change" />
            </div>
            <div>
                <String label="ProdName" v-model="item.prodName" :editMode="editMode" @change="change" />
            </div>
            <div>
